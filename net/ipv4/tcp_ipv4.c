...
const struct tcp_request_sock_ops tcp_request_sock_ipv4_ops = {
	...
	.init_seq_and_ts_off	=	tcp_v4_init_seq_and_ts_off,//生成ts offset
...
lookup:
	//查询此报文对应的socket
	sk = __inet_lookup_skb(skb, __tcp_hdrlen(th)/*tcp头部长度*/, th->source/*源端口*/,
...
struct proto tcp_prot = {
	...
	.recvmsg		= tcp_recvmsg,
	.sendmsg		= tcp_sendmsg,
	.splice_eof		= tcp_splice_eof,/*page数据发送*/
