		...
		struct mempolicy *pol, pgoff_t ilx, int nid)
{
	...
	page = __alloc_frozen_pages_noprof(gfp, order, nid, nodemask);/*申请物理页*/
 ...
 * Return: The page on success or NULL if allocation fails.
 */
struct page *alloc_pages_noprof(gfp_t gfp, unsigned int order/*大小*/)
{
...
struct folio *folio_alloc_noprof(gfp_t gfp, unsigned int order)
{
	...
	return page_rmappable_folio(alloc_pages_noprof(gfp | __GFP_COMP/*指明按组合页初始化*/, order));
}
