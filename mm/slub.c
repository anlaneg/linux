...
/*自slab中申请obj*/
static __fastpath_inline void *slab_alloc(struct kmem_cache *s/*自哪个slab进行申请*/, struct list_lru *lru,
...
static inline int __kmem_cache_alloc_bulk(struct kmem_cache *s, gfp_t flags,
			size_t size/*要申请的数目*/, void **p/*出参，记录申请的obj*/, struct obj_cgroup *objcg)
{
	struct kmem_cache_cpu *c;
