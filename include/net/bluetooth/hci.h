...
enum {
	...
	HCI_MGMT_EXP_FEATURE_EVENTS,/*标记此socket可以收取扩展功能事件*/
};
...
enum {
	...
	HCI_CONFIG,
	HCI_DEBUGFS_CREATED,
	HCI_POWERING_DOWN,/*正在将设置置为power down*/
	HCI_AUTO_OFF,
	HCI_RFKILLED,
	HCI_MGMT,
	HCI_BONDABLE,/*标记设备可bond*/
	HCI_SERVICE_CACHE,
	HCI_KEEP_DEBUG_KEYS,
	HCI_USE_DEBUG_KEYS,
	HCI_UNREGISTER,/*设备解注册*/
	HCI_UNCONFIGURED,
	HCI_USER_CHANNEL,
	HCI_EXT_CONFIGURED,
	HCI_LE_ADV,
	HCI_LE_PER_ADV,
	HCI_LE_SCAN,
	HCI_SSP_ENABLED,/*标记设备开启了simple pair*/
	HCI_SC_ENABLED,
	HCI_SC_ONLY,
	HCI_PRIVACY,
	HCI_LIMITED_PRIVACY,
	HCI_RPA_EXPIRED,
	HCI_RPA_RESOLVING,
	HCI_LE_ENABLED,/*标记低功耗开启*/
	HCI_ADVERTISING,
	HCI_ADVERTISING_CONNECTABLE,
	HCI_CONNECTABLE,/*标记设备可连接*/
	HCI_DISCOVERABLE,/*标记设备可被发现*/
	HCI_LIMITED_DISCOVERABLE,/*标记设备可被有限发现(在一定时间内可见,超时会关闭)*/
	HCI_LINK_SECURITY,
	HCI_PERIODIC_INQ,
	HCI_FAST_CONNECTABLE,
	HCI_BREDR_ENABLED,/*标记br/edr开启(此标式仅在LE被设置后才可设置)*/
