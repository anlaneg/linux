 ...
 */
void print_tracepoint_events(const char *subsys_glob/*用于匹配子系统*/,
			     const char *event_glob/*用于匹配event*/, bool name_only)
{
	DIR *sys_dir, *evt_dir;
...
void print_symbol_events(const char *event_glob/*进行event通配*/, unsigned int type,
