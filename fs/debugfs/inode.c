...
static struct dentry *debugfs_start_creating(const char *name/*目录名*/,
					     struct dentry *parent/*父节点*/)
{
	struct dentry *dentry;
	int error;
...
struct dentry *debugfs_create_file_full(const char *name/*属性文件名称*/, umode_t mode,
