...
static int do_proc_dointvec(const struct ctl_table *table/*待填充或读取的数据*/, int dir,
		  void *buffer/*write时使用的待解析buffer,read时使用的格式化buffer*/, size_t *lenp/*出参，剩余长度*/, loff_t *ppos,
		  int (*conv/*转换回调*/)(bool *negp, unsigned long *u_ptr, int *k_ptr,
			      int dir, const struct ctl_table *table))
{
	...
	i = (int *) table->data;/*i指向tbl_data的每一个项*/
