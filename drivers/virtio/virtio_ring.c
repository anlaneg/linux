 ...
 */
//自_vq中收取一个buf,返回buf的长度。及buf对应的描述符指针
	...
	const char *name)//队列名称
{
	...
	//初始化vring(num 队列大小，queue 队列指针,vring_align对齐方式）
