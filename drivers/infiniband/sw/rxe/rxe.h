...
enum resp_states {
	...
	RESPST_ERR_PSN_OUT_OF_SEQ,/*psn乱序到达*/
	RESPST_ERR_MISSING_OPCODE_FIRST,/*rc情况下缺少first*/
	RESPST_ERR_MISSING_OPCODE_LAST_C,/*rc 缺少last opt*/
	RESPST_ERR_MISSING_OPCODE_LAST_D1E,/*uc情况下缺少last opt*/
