...
//Events generated by hardware are posted to Event Queues (EQs).
struct mlx5_eq {
	struct mlx5_core_dev    *dev;//eq从属的设备
...
struct mlx5_eq_comp {
	...
	struct list_head        list;//用于eq串连
};

/*获取指定编号的eqe*/
static inline struct mlx5_eqe *get_eqe(struct mlx5_eq *eq, u32 entry/*eqe的编号*/)
{
