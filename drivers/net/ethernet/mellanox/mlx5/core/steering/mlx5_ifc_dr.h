...
enum {
	MLX5DR_ACTION_MDFY_HW_FLD_L2_0		= 0,//2层0号（目的mac 48bits)
	MLX5DR_ACTION_MDFY_HW_FLD_L2_1		= 1,//2层1号 (源mac  48bits)
	MLX5DR_ACTION_MDFY_HW_FLD_L2_2		= 2,//2层3号 （以太类型 32bits,tci+ethertype)
